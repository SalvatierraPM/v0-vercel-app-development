...
export async function POST(request: Request) {
  try {
    ...
    console.log(`Webhook recibido para cotización: ${id}`)
        ...
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <div style="padding: 20px;">
            ...
            <div style="margin-top: 30px; text-align: center;">
              <a href="${appUrl}/cotizacion/${cotizacion.id}" style="background-color: #059669; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;">Ver mi cotización</a>
            </div>
          </div>
